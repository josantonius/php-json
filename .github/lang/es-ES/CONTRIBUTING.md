...
Empieza una [nueva discusión](https://github.com/josantonius/php-json/discussions/new) y selecciona
...
abre una [nueva discusión](https://github.com/josantonius/php-json/discussions/new) en la categoría
...
[repositorio](https://github.com/josantonius/php-json). O mejor aún, puedes
...
[Envía un nuevo _issue_](https://github.com/josantonius/php-json/issues/new) para reportar un error.
...
1. Busca en [GitHub](https://github.com/josantonius/php-json/pulls) si existe algún tema relacionado
para asegurarte que no esté repetido.

1. [Bifurca](https://github.com/josantonius/php-json/fork) el repositorio a tu propia cuenta de GitHub.
...
1. En GitHub, envía un [_pull request_](https://github.com/josantonius/php-json/compare/main..)
hacia `php-json:main`.
